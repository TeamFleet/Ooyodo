...
const { enemyIdStartFrom, pathname, proxy: _proxy } = require('../vars.cjs');
const batch = require('./batch.cjs');

const getPicUrlShip = require('../commons/get-pic-url-ship.cjs');
const fetchFile = require('../commons/fetch-file.cjs');
const wait = require('../commons/wait.cjs');
