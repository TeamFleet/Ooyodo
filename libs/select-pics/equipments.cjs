...
const { db, pathname, enemyEquipmentIdStartFrom } = require('../vars.cjs');
    ...
    new Promise(async (resolve, reject) => {
        ...
        // 检查新增
        {
            ...
            list.filter((filename) => {
                ...
                if (id >= enemyEquipmentIdStartFrom || id in db.equipments)
                    return false;
                ...
                .forEach((equipment) => {
                    const dirEquipment = path.resolve(dir, `./${equipment.id}`);
